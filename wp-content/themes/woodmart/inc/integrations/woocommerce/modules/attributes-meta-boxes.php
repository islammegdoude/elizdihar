...
if ( ! function_exists( 'woodmart_wc_attribute_update' ) ) {
	...
	function woodmart_wc_attribute_update( $attribute_id, $attribute, $old_attribute_name ) {
		...
		update_option( 'woodmart_pa_' . $attribute['attribute_name'] . '_thumbnail', sanitize_text_field( $attribute_thumbnail ), false );

		$attribute_hint = isset( $_POST['attribute_hint'] ) ? $_POST['attribute_hint'] : ''; // phpcs:ignore.
		update_option( 'woodmart_pa_' . $attribute['attribute_name'] . '_hint', sanitize_text_field( $attribute_hint ), false );
...
if ( ! function_exists( 'woodmart_wc_attribute_add' ) ) {
	...
	function woodmart_wc_attribute_add( $attribute_id, $attribute ) {
		...
		$attribute_thumbnail = isset( $_POST['product_attr_thumbnail_id'] ) ? $_POST['product_attr_thumbnail_id'] : ''; // phpcs:ignore.
		add_option( 'woodmart_pa_' . $attribute['attribute_name'] . '_thumbnail', sanitize_text_field( $attribute_thumbnail ), '', false );

		$attribute_hint = isset( $_POST['attribute_hint'] ) ? $_POST['attribute_hint'] : ''; // phpcs:ignore.
		add_option( 'woodmart_pa_' . $attribute['attribute_name'] . '_hint', sanitize_text_field( $attribute_hint ), '', false );
